...
declare module 'inquirer' {
    interface PressToContinuePromptOptions<T extends inquirer.Answers = inquirer.Answers> extends inquirer.InputQuestionOptions<T> {
    }
    /**
     ...
     */
    interface PressToContinuePrompt<T extends inquirer.Answers = inquirer.Answers> extends PressToContinuePromptOptions<T> {
        /**
         * @inheritdoc
         */
